...
namespace MeChat.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240921071057_AddNotificationEntity")]
            ...
            modelBuilder.Entity("MeChat.Domain.Entities.Friend", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6797), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6823), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 1,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6829), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6830), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 2,
                            SpecifierId = new Guid("ed003c55-0557-4885-9055-c0c47cc4f7ab"),
                            Status = 3
                        },
                        new
                        {
                            ...
                            UserSecondId = new Guid("6b44f7b1-b873-44ef-9491-ffe41f5775ed"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6842), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 271, DateTimeKind.Unspecified).AddTicks(6842), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 2,
            ...
            modelBuilder.Entity("MeChat.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2120), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "mechat.mail@gmail.com",
                            Fullname = "test",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2134), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test",
                            RoleId = 2,
                            Status = 1,
                            Username = "test"
                        ...
                        new
                        {
                            ...
                            CoverPhoto = "https://images.pexels.com/photos/956981/milky-way-starry-sky-night-sky-star-956981.jpeg?auto=compress&cs=tinysrgb&w=600",
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2140), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "leduchieu2001x@gmail.com",
                            Fullname = "test1",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2141), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test1",
                            RoleId = 2,
                            Status = 1,
                            Username = "test1"
                        ...
                        new
                        {
                            ...
                            CoverPhoto = "https://images.pexels.com/photos/956981/milky-way-starry-sky-night-sky-star-956981.jpeg?auto=compress&cs=tinysrgb&w=600",
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2144), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "hieuldhe150703@fpt.edu.vn",
                            Fullname = "test2",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 14, 10, 57, 273, DateTimeKind.Unspecified).AddTicks(2145), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test2",
                            RoleId = 2,
                            Status = 1,
                            Username = "test2"
