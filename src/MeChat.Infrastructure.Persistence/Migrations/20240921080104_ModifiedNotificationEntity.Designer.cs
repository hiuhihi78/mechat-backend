...
namespace MeChat.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240921080104_ModifiedNotificationEntity")]
            ...
            modelBuilder.Entity("MeChat.Domain.Entities.Friend", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(958), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(981), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 1,
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(988), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(989), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 2,
                            SpecifierId = new Guid("ed003c55-0557-4885-9055-c0c47cc4f7ab"),
                            Status = 3
                        },
                        new
                        {
                            ...
                            UserSecondId = new Guid("6b44f7b1-b873-44ef-9491-ffe41f5775ed"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(1000), new TimeSpan(0, 7, 0, 0, 0)),
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 987, DateTimeKind.Unspecified).AddTicks(1001), new TimeSpan(0, 7, 0, 0, 0)),
                            OldStatus = 2,
            ...
            modelBuilder.Entity("MeChat.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8370), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "mechat.mail@gmail.com",
                            Fullname = "test",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8386), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test",
                            RoleId = 2,
                            Status = 1,
                            Username = "test"
                        ...
                        new
                        {
                            ...
                            CoverPhoto = "https://images.pexels.com/photos/956981/milky-way-starry-sky-night-sky-star-956981.jpeg?auto=compress&cs=tinysrgb&w=600",
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8391), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "leduchieu2001x@gmail.com",
                            Fullname = "test1",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8392), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test1",
                            RoleId = 2,
                            Status = 1,
                            Username = "test1"
                        ...
                        new
                        {
                            ...
                            CoverPhoto = "https://images.pexels.com/photos/956981/milky-way-starry-sky-night-sky-star-956981.jpeg?auto=compress&cs=tinysrgb&w=600",
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8394), new TimeSpan(0, 7, 0, 0, 0)),
                            Email = "hieuldhe150703@fpt.edu.vn",
                            Fullname = "test2",
                            ModifiledDate = new DateTimeOffset(new DateTime(2024, 9, 21, 15, 1, 3, 988, DateTimeKind.Unspecified).AddTicks(8395), new TimeSpan(0, 7, 0, 0, 0)),
                            Password = "test2",
                            RoleId = 2,
                            Status = 1,
                            Username = "test2"
